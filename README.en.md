...
If a repository deviates from the organization-level defaults, it should clearly state the deviation in its README.

## Maintenance Principles

- Keep documents clear and usable.
- Preserve bilingual readability with separate language versions where appropriate.
- Do not publish real recruitment questions, interview questions, scoring rubrics, candidate records, credentials, tokens, or recovery materials.
- Prefer small, reviewable changes through Pull Requests.
